function CompleteComp({ continueToNextSet }) {
    return (
        <div className="rounded m-5 p-10 bg-gradient-to-r from-blue-200 to-blue-100">
            <h1 className="text-2xl mt-5 mb-5 text-center font-extrabold">Displaying complete comp!</h1>
